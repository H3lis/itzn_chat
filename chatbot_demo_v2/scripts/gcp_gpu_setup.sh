...
pip install fastapi uvicorn sentence-transformers chromadb rank_bm25 langgraph langchain-core kiwipiepy pdfplumber pymupdf requests python-dotenv ollama pandas openpyxl rapidfuzz pyyaml
